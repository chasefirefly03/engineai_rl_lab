...
void pm01_controller::ControlCallback() {   
    ...
    Eigen::Vector3f velocity_commands = Eigen::Vector3f(velocity_commands_->linear_velocity[0],velocity_commands_->linear_velocity[1],velocity_commands_->yaw_velocity).cast<float>();
