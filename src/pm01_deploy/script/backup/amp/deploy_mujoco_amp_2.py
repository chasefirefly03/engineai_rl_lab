...
if __name__ == "__main__":
    ...
    with open(config_file, "r") as f:
        ...
        num_actions = 24
        num_obs = 99 # Dimensions of a single observation frame
        history_length = 5
    ...
    with mujoco.viewer.launch_passive(m, d) as viewer:
        ...
        while viewer.is_running() and time.time() - start < simulation_duration:
            ...
            if counter % control_decimation == 0:
                ...
                # 0. base_ang_vel (3) - in Base Frame (MuJoCo qvel 3:6 for free joint is already in body frame)
                base_ang_vel_b = d.qvel[3:6]
                
                # 1. projected_gravity (3)
                projected_gravity = get_gravity_orientation(base_quat_w) # Returns (3,)
